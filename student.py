...
class Student:
    def __init__(self,root):
        ...
        #take the image from file
        #third image
        img2=Image.open(r"C:\Users\SATYAM\Desktop\face_recognition_app\image\student_details3.jpg")
        ...
        #title of project
        title_lbl=Label(bg_img,text="STUDENT MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),bg="gray",fg="black")
        ...
        #current course    
        current_course_frame=LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text="Curent Course Information",font=("times new roman",12,"bold"))
        current_course_frame.place(x=5,y=135,width=705,height=120)
        ...
        course_combo["values"]=("Select Course","c++","Design and analysis","Data Structure And algorithm","Computer networks")
        ...
        sem_combo["values"]=("Select Smester","sem-1","sem-2","sem-3","sem-4","sem-5","sem-6","sem-7","sem-8")
        sem_combo.current(0)
        sem_combo.grid(row=1,column=3,padx=2,pady=10,sticky=W)

        #class student information    
        class_student_frame=LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text="Class Student Information",font=("times new roman",12,"bold"))
        class_student_frame.place(x=5,y=255,width=705,height=300)
        ...
        img_right=Image.open(r"C:\Users\SATYAM\Desktop\face_recognition_app\image\student_details2.jfif")
        img_right=img_right.resize((710,130),Image.ANTIALIAS)  #resize of image
        self.photoimg_right=ImageTk.PhotoImage(img_right)

        f_lbl=Label(Right_frame,image=self.photoimg_right)  #create label
        f_lbl.place(x=5,y=0,width=710,height=130) #to show the image on window
    ...
    def add_data(self):
        if self.var_dep.get()=="select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="" or self.var_address=="" or self.var_course=="" or self.var_div=="" or self.var_dob=="" or self.var_email=="" or self.var_gender=="" or self.var_phone=="" or self.var_radio1=="" or self.var_roll=="" or self.var_semester=="" or self.var_teacher=="" or self.var_year=="" :
            messagebox.showerror("Error","All fields are required",parent=self.root)
        else:
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="41352000",database="face_recognizer")
    ...
    def update_data(self):
        ...
        if self.var_dep.get()=="select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="" or self.var_course=="" or self.var_div=="" or self.var_dob=="" or self.var_gender=="" or self.var_phone=="" or self.var_radio1=="" or self.var_roll=="" or self.var_semester=="":
            messagebox.showerror("Error","All fields are required",parent=self.root)
        else:
            try:
            ...
            try:
                ...
                def face_cropped(img):
                    ...
                    for (x,y,w,h) in faces:
                        ...
                        return face_cropped
                cap=cv2.VideoCapture(0)  #if we take its value 0 it means system webcam use and if take 1 out side webcame will use but connection should be there 
                img_id=0
                while True:
